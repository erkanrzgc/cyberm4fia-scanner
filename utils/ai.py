...
_SKILL_MAP = {
    ...
    "cache_poisoning": "offensive-cache-poisoning",
    "esi_injection": "offensive-esi-injection",
    "esi": "offensive-esi-injection",
    "authz_audit": "offensive-authz-bypass-systematic",
    "broken_access_control": "offensive-authz-bypass-systematic",
    "llm_endpoint": "offensive-llm-app-pentest",
    "llm_prompt_injection": "offensive-llm-app-pentest",
    "llm_jailbreak": "offensive-llm-app-pentest",
    "llm_data_leakage": "offensive-llm-app-pentest",
    "llm_vulnerability": "offensive-llm-app-pentest",
    "garak": "offensive-llm-app-pentest",
